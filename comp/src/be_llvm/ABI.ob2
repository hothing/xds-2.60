...
(* The conventional stack frame appearance for PPC PowerOpen ABI is:
 │ CALLER'S FRAME  │
 │                 │
 ├─────────────────┤ <-16  old SP, SAVEDREG_AREA_START = 0
 │  FPR save area  │
 ├─────────────────┤ <-8
 │  GPR save area  │
 ├─────────────────┤ <-4   = LOCAL_AREA_START = - SAVEDREG_AREA_SIZE
 │     Locals      │
 ├─────────────────┤ <-4   = TEMP_AREA_START = LOCAL_AREA_START - LOCAL_AREA_SIZE
 │_alignment_bytes_│
 │    Temp area    │
 ├─────────────────┤ <-4
 │ Parameter area  │
...
--------------------------------------------------------------------------------
VAR
  ProcABI *: at.AbiType;  -- ABI ухэхЁшЁєхьющ яЁюЎхфєЁ√ 
