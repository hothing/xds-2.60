...
class Segment : public ForeverObject {
  ...
  public:
    ...
    Segment *           next;           /* ┬ юс·хъЄэюь Їрщых */
    Segment *           link;           /* ┬ collection      */
    dword               alignment;
...
extern int NFixups;          /* ╬с∙хх шї ъюышўхёЄтю т т√фртрхьющ яЁюуЁрььх */
...
extern dword ImportStart; /* ╥рсышЎр яхЁхїюфют эр шьяюЁЄшЁютрээ√х шьхэр -
                              тэєЄЁш ёхуьхэЄр ъюфр ш яЁшцрЄю ъ хую ъюэЎє */
